          ...
          orders.map((order, index) => (
            <div className="grid grid-cols-1 sm:grid-cols-[0.5fr_2fr_1fr] lg:grid-cols-[0.5fr_2fr_1fr_1fr_1fr] gap-3 items-start border-gray-200 p-5 md:p-8 my-3 md:my-4 text-xs sm:text-sm text-gray-700" key={index}>
              ...
              <div>
                ...
                <p>Pagamento : {order.payment ? "Effettuato" : "In sospeso"}</p>
              ...
              <select onChange={(event)=>statusHandler(event, order._id)} value={order.status} className="p-2 font-semibold">
                <option value="Ordine Effettuato">Ordine Effettuato</option>
                <option value="Imballaggio">Imballaggio</option>
                <option value="Spedito">Spedito</option>
                <option value="Fuori consegna">Fuori consegna</option>
